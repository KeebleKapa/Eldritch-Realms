package net.keeblekapa.eldritchrealms.world.tree.custom;
...
public class UmbramOakTrunkPlacer extends TrunkPlacer {
    public static final Codec<UmbramOakTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, UmbramOakTrunkPlacer::new));
    ...
    public List<FoliagePlacer.TreeNode> generate(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer,
        ...
        for (int i = 0; i < height_; i++) {
            getAndSetState(world, replacer, random, startPos.up(1), config);
